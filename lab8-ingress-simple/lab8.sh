...
curl --resolve "localhost:80:$( minikube ip )" -i http://localhost/service-b


# kiểm tra log của ngĩnx controller
 kubectl get pods -n ingress-nginx
kubectl logs -n ingress-nginx ingress-nginx-controller-768f948f8f-5glfp 

# lấy ra ip trong nginx chỉ định
